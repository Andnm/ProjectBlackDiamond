  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        ...
        <h1 className="mt-3 font-headline text-3xl text-white">Sửa: {fromLocalizedJson(piece.name) || piece.slug}</h1>
      </div>

      <PieceForm action={updateWithId} piece={piece} submitLabel="Lưu thay đổi" />
    </div>
  );
}
